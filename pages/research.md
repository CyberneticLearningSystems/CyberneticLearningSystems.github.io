    ...
    <summary><b>Simulation</b></summary>
        ...
        <table>
            ...
            <tr> 
                ...
                <td>MSc</td>
                <td>MT</td>
                <td><a src="./papers-theses/MT-janik-vollenweider.md">High-Fidelity UAV Simulation Tool for the Support<br>of SORA Process Based Validation of Operational<br>Flight Volume and Ground Risk Buffer</a></td>
            </tr>
        </table>
        <br>
        <b>Types:</b>
